...
// Requires a buffered array of 10 sphere structs
...
void Snowman(Sphere* spheres, Vector center) {
    ...
    // buttons
    spheres[6] = (Sphere) {{0 + center.x, 0.3 + center.y, -0.405 + center.z}, 0.03f, 2};
    spheres[7] = (Sphere) {{0 + center.x, 0.2 + center.y, -0.465 + center.z}, 0.03f, 2};
    spheres[8] = (Sphere) {{0 + center.x, 0.1 + center.y, -0.49 + center.z}, 0.03f, 2};
    spheres[9] = (Sphere) {{0 + center.x, 0.0 + center.y, -0.49 + center.z}, 0.03f, 2};
}